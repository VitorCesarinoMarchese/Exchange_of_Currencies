...
const { app } = createServer();
  ...
  describe("Chart System", () => {
    describe("Chart Handler", () => {
      ...
      describe("given the day result is correct", () => {
      ...
      describe("given the week result is correct", () => {
        it("should return a 200 and correct data", async () => {
          const mockData: Result = {
              base_currency: "USD",
              end_date: "2025-03-11-14:00",
          ...
          const res = await request(app).get(`/api/chart/week/USDGBP`);
          expect(res.status).toBe(200);
          expect(res.body).toEqual({result: mockData});
        });
      });

      describe("given the month result is correct", () => {
        it("should return a 200 and correct data", async () => {
          const mockData: Result = {
              base_currency: "USD",
              end_date: "2025-03-11-14:00",
          ...
          const res = await request(app).get(`/api/chart/month/USDGBP`);
          expect(res.status).toBe(200);
          expect(res.body).toEqual({result: mockData});
        });
      });

      describe("given the year result is correct", () => {
        it("should return a 200 and correct data", async () => {
          const mockData: Result = {
              base_currency: "USD",
              end_date: "2025-03-11-14:00",
          ...
          const res = await request(app).get(`/api/chart/year/USDGBP`);
          expect(res.status).toBe(200);
          expect(res.body).toEqual({result: mockData});
        });
      });
