...
function Chart() {
  ...
  if(loading){ return (    <div className="bg-primary p-4 max-w-[352px] rounded-2xl flex flex-col gap-4">
    <div className="max-w-[375px] bg-white rounded-2xl">
      <VictoryChart
        width={375}
  ...
  if(error){return (    <div className="bg-primary p-4 max-w-[352px] rounded-2xl flex flex-col gap-4">
    <div className="max-w-[375px] bg-white rounded-2xl">
      Error: {error}
    </div>
    <ul className="flex gap-4 overflow-x-auto whitespace-nowrap -mx-4">
  ...
  return (
    <div className="bg-primary p-4 max-w-[352px] rounded-2xl flex flex-col gap-4">
      <div className="max-w-[375px] bg-white rounded-2xl">
        <VictoryChart
          width={375}
          theme={VictoryTheme.clean}
