...
describe('TransactionHistory', () => {
  ...
  beforeEach(() => {
    (useHistory as any).mockReturnValue({ history: mockTransactions, loading: false, error: null });
    (useLocation as any).mockReturnValue({ pathname: '/history' });
  });
  ...
  it('renders loading row when loading is true', async () => {
    (useHistory as any).mockReturnValue({ history: [], loading: true, error: null });
    render(<TransactionHistory reloadTrigger={true} />);
    await waitFor(() => {
  ...
  it('renders "No transactions found." when history is empty', async () => {
    (useHistory as any).mockReturnValue({ history: [], loading: false, error: null });
    render(<TransactionHistory reloadTrigger={true} />);
    await waitFor(() => {
